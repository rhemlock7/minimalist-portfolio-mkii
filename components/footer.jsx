  ...
  return (
    <footer className='flex flex-col mb-8 pt-10 border-t-2 lg:flex-row lg:justify-between lg:items-center'>
      <div className='flex flex-col py-4 lg:flex-row'>
        <a href='https://github.com/rhemlock7' target='blank' rel='noreferrer' className='lg:mr-5'>Github</a>
        <a href='https://www.linkedin.com/in/ryan-hemlock/' target='blank' rel='noreferrer' className='lg:mx-5'>LinkedIn</a>
      </div>
